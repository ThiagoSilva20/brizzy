...
const Footer = () => {
  return (
    <footer className="w-full lg:max-w-screen border-t bg-background">
      <div className="flex flex-col gap-6 py-12 px-4 md:px-6 md:flex-row md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8 md:w-2/3">
      ...
      <div className="border-t py-6">
        <div className="container flex flex-col items-center justify-between gap-4 px-4 md:px-6 md:flex-row">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Brizzy Desk. Todos os direitos
            reservados.
          </p>
          <p className="text-xs text-muted-foreground">
